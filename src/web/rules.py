...
IDENTITY = ("preset", "country", "currency", "valid_from", "title", "language")
# `language` — язык, на котором написан сам пресет, а не правило расчёта: править
# его с экрана правил нечего. До 25.09.2026 он в этот список не попал и выходил
# на экран отдельным разделом с сырым ключом «language».
...
SECTION_TITLES = {
    ...
    "manual_correction": lambda: _("Ручная корректировка"),
